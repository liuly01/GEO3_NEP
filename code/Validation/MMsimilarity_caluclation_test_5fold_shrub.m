...
% File paths
allsampleFile = 'D:\han05\data\fluxdata\MM\Classification\PFT\dataset_newevi\shrub.csv';

% Load data
allsampleData = readtable(allsampleFile);
allsampleVars = table2array(allsampleData(:, [21, 17, 27, 33, 14, 29, 30, 16]));
sampleNEE = table2array(allsampleData(:, 5));
siteNames = allsampleData{:, 1};

% Define weights for each environmental variable
weights = [0.11, 0.05, 0.18, 0.07, 0.24, 0.12, 0.06, 0.17];  % shrub
