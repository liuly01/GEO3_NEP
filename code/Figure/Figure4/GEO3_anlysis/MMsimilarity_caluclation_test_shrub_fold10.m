...
% File paths
allsampleFile = 'PFT\shrub.csv';

% Load data
allsampleData = readtable(allsampleFile);
allsampleVars = table2array(allsampleData(:, [21, 15, 27, 33, 14, 29, 30, 16])); % Extract environmental variables
...
weights = [0.1, 0.18, 0.17, 0.07, 0.16, 0.11, 0.05, 0.15];  % shrub
