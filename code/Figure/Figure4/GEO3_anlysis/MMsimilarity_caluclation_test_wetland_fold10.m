...
% File paths
allsampleFile = 'PFT\wetland.csv';

% Load data
allsampleData = readtable(allsampleFile);
allsampleVars = table2array(allsampleData(:, [14, 30, 27, 17, 20, 29, 15, 16])); % Extract environmental variables
...
weights = [0.15, 0.06, 0.14, 0.08, 0.18, 0.14, 0.12, 0.13];  % wetland
