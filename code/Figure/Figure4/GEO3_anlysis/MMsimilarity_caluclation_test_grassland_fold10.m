...
% File paths
allsampleFile = 'PFT\grassland.csv';

% Load data
allsampleData = readtable(allsampleFile);
allsampleVars = table2array(allsampleData(:, [14, 27, 21, 18, 29, 22, 19])); % Extract environmental variables
...
weights = [0.23, 0.23, 0.16, 0.08, 0.10, 0.1, 0.1];  % grassland
